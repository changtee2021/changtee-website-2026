...
export const HOME_SECTION_DEFS: SectionDef[] = [
  {
    ...
    fields: [
      ...
      { type: "image", key: "tile1Image", label: "รูป 1 — ผ้าม่าน", aspectClassName: "aspect-[716/1024]" },
      { type: "text", key: "tile1Name", label: "ชื่อ 1", maxLength: 40 },
      { type: "link", key: "tile1Href", label: "ลิงก์ 1" },
      { type: "image", key: "tile2Image", label: "รูป 2 — ม่านม้วน", aspectClassName: "aspect-[716/1024]" },
      { type: "text", key: "tile2Name", label: "ชื่อ 2", maxLength: 40 },
      { type: "link", key: "tile2Href", label: "ลิงก์ 2" },
      { type: "image", key: "tile3Image", label: "รูป 3 — มู่ลี่ไม้", aspectClassName: "aspect-[716/1024]" },
      { type: "text", key: "tile3Name", label: "ชื่อ 3", maxLength: 40 },
      { type: "link", key: "tile3Href", label: "ลิงก์ 3" },
      { type: "image", key: "tile4Image", label: "รูป 4 — มู่ลี่อลูมิเนียม", aspectClassName: "aspect-[716/1024]" },
      { type: "text", key: "tile4Name", label: "ชื่อ 4", maxLength: 40 },
      { type: "link", key: "tile4Href", label: "ลิงก์ 4" },
      { type: "image", key: "tile5Image", label: "รูป 5 — ม่านปรับแสง", aspectClassName: "aspect-[716/1024]" },
      { type: "text", key: "tile5Name", label: "ชื่อ 5", maxLength: 40 },
      { type: "link", key: "tile5Href", label: "ลิงก์ 5" },
      { type: "image", key: "tile6Image", label: "รูป 6 — ฉากกั้น", aspectClassName: "aspect-[716/1024]" },
      { type: "text", key: "tile6Name", label: "ชื่อ 6", maxLength: 40 },
      { type: "link", key: "tile6Href", label: "ลิงก์ 6" },
      { type: "image", key: "tile7Image", label: "รูป 7 — พิมพ์ลาย", aspectClassName: "aspect-[716/1024]" },
      { type: "text", key: "tile7Name", label: "ชื่อ 7", maxLength: 40 },
      { type: "link", key: "tile7Href", label: "ลิงก์ 7" },
      { type: "image", key: "tile8Image", label: "รูป 8 — วอลเปเปอร์", aspectClassName: "aspect-[716/1024]" },
  ...
  {
    id: "installVideos",
    label: "คลิปติดตั้ง YouTube",
    description:
      "บล็อกใต้ผลงาน — เครื่องเล่นใหญ่ + ติดตามช่อง + เลือกคลิปด้านล่าง",
    fields: [
      {
        type: "text",
        key: "eyebrow",
        label: "ป้ายเล็ก (เช่น Youtube Channel)",
        maxLength: 40,
      },
      { type: "text", key: "title", label: "ชื่อช่อง / หัวข้อ", maxLength: 60 },
      { type: "textarea", key: "subtitle", label: "คำโปรย" },
      {
        type: "text",
        key: "channelLabel",
...
export const HOME_SECTION_DEFAULTS: Record<string, Record<string, string>> = {
  products: {
    ...
    tile1Image: "/images/home/products/01-curtain.png",
    tile1Name: "ผ้าม่าน",
    tile1Href: "/products/curtain",
    tile2Image: "/images/home/products/02-roller.png",
    tile2Name: "ม่านม้วน",
    tile2Href: "/products/roller-blinds",
    tile3Image: "/images/home/products/03-wood.png",
    tile3Name: "มู่ลี่ไม้",
    tile3Href: "/products/venetian-blinds/wood",
    tile4Image: "/images/home/products/08-aluminium.png",
    tile4Name: "มู่ลี่อลูมิเนียม",
    tile4Href: "/products/venetian-blinds/aluminium",
    tile5Image: "/images/home/products/04-vertical.png",
    tile5Name: "ม่านปรับแสง",
    tile5Href: "/products/vertical-blinds",
    tile6Image: "/images/home/products/05-folding.png",
    tile6Name: "ฉากกั้นห้อง",
    tile6Href: "/products/pvc-partition",
    tile7Image: "/images/home/products/06-noren.png",
    tile7Name: "ม่านพิมพ์ลาย",
    tile7Href: "/products/print-fabric",
    tile8Image: "/images/home/products/07-wallpaper.png",
    tile8Name: "วอลเปเปอร์",
    tile8Href: "/products/surface",
  },
  portfolio: {
  ...
  installVideos: {
    ...
    title: "ช่างตี๋ ออกแบบ-ติดตั้ง ผ้าม่าน",
    subtitle: "กดเล่นคลิปติดตั้งจริงได้เลย — อยากดูเพิ่มไปต่อที่ช่อง YouTube",
    channelLabel: "ติดตาม",
  },
  howItWorks: {
    titleLine1: "เพิ่งเริ่มเลือกม่าน?",
    titleLine2: "เริ่มตรงนี้ได้เลย",
    intro:
      "ไม่ต้องรู้เรื่องม่านมาก่อนก็ได้ บอกแค่ห้องไหน อยากได้แบบไหน ที่เหลือเราช่วยดูให้",
    step1Title: "เลือกแบบม่าน มู่ลี่",
    step1Desc:
      "มีทั้งม่านผ้า มู่ลี่ ม่านม้วน และอีกหลายแบบ บอกห้องกับสไตล์ที่ชอบ เราช่วยจับคู่ให้เหมาะกับการใช้งานจริง",
  ...
  stats: {
    ...
    image: "/images/about/showroom-interior.webp",
